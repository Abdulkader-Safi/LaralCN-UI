    ...
    <main class="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-2xl text-center">
            <h1
                ...
                Build faster with LaralCN-UI
            </h1>
            <p class="mt-4 text-lg text-muted-foreground">
                Copy-and-own Blade components, styled with Tailwind. This navbar
                is a ready-made block you install with one command.
            </p>
            <div class="mt-8 flex items-center justify-center gap-3">
                <x-ui.button size="lg">Get Started</x-ui.button>
                <x-ui.button size="lg"
                    variant="outline">Documentation</x-ui.button>
            </div>
        </div>
    </main>
</div>
