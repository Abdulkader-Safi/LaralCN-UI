{{--
    ...
    The five columns are a plain list, so pass three and you get three.
        ...
        <div
            ...
            <div class="flex flex-col gap-1">
                <h3 class="text-sm font-semibold text-foreground">
                    {{ $newsletterTitle }}</h3>
                <p class="text-sm text-muted-foreground">{{ $newsletterText }}
                </p>
            </div>
            ...
            <div class="flex flex-col gap-2 lg:w-96">
                <form class="flex flex-col gap-2 sm:flex-row"
                    ...
                    <x-ui.input id="footer-02-email" type="email" name="email"
